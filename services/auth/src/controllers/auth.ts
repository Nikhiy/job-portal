...
export const registerUser=TryCatch(async(req,res,next)=>{
    ...
    if(role==="recruiter"){
        ...
        (${name},${email},${hashPassword},${phoneNumber},${role},${bio},${data.url},${data.public_id}) RETURNING user_id,name,email,phone_number,role,bio,resume,created_at`;registeredUser=user
    }
